...
- [x] Update the frontend CI runner to a Node version supported by the controlled Next.js upgrade and verify the full pipeline without weakening release checks.
